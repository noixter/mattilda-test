...
class TestIntegrationInvoices:
    ...
    async def test_list_invoices_filter_by_student(self, client: AsyncClient, sample_invoices, sample_students):
    ...
    async def test_list_invoices_filter_by_school(self, client: AsyncClient, sample_invoices, sample_schools):
